...
// Uncommenting either of those changes the behavior for `presentedItemDidChange` for one of the two documents.

//- (void)accommodatePresentedItemDeletionWithCompletionHandler:(void (^)(NSError *_Nullable))completionHandler {
//    NSLog(@"Presented file will be deleted notification: %@", self.presentedItemURL);
//}

//- (void)savePresentedItemChangesWithCompletionHandler:(void (^)(NSError *))completionHandler {
//    NSLog(@"Presented item should save notification: %@", self.presentedItemURL);
