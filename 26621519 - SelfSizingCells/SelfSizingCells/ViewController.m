...
@property (nonatomic, readonly) NSMutableDictionary *textCache;
...
- (instancetype)initWithCoder:(NSCoder *)aDecoder {
    ...
    if (self) {
        _textCache = [NSMutableDictionary new];
    }
    return self;
}
